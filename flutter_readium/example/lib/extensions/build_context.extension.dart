...
extension ContextExtension on BuildContext {
  bool get isxSmallScreen =>
      portraitBreakpoint.name == ScreenBreakpointEnum.xsm.name;
  bool get isSmallScreen =>
      portraitBreakpoint.name == ScreenBreakpointEnum.sm.name;

  bool get isSmallDownScreen => isSmallScreen || isxSmallScreen; // is used

  Size get screenSize => MediaQuery.sizeOf(this);

  ScreenBreakpointEnum get portraitBreakpoint =>
      _getScreenBreakpoint(screenSize.width);

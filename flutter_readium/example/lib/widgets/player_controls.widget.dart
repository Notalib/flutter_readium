...
import 'package:flutter_readium/flutter_readium.dart' show Locator, Publication, TTSPreferences;
      ...
      return Row(
        ...
        children: [
          IconButton(
            ...
            onPressed: () => context.read<PlayerControlsBloc>().add(SkipToPreviousChapter(publication: publication)),

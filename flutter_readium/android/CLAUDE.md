...
- **Gate scope:** for Kotlin-only changes, the Android checks are sufficient. Run the repo-wide Dart format/analyze gates only when Dart or shared API files also changed.

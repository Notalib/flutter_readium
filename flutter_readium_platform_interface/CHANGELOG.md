...
- `AudioRecoveryPolicy.recoverOnResourceLoadingTimeout` lets applications opt into rebuilding the
  audio navigator after a suspected resource-loading timeout. It defaults to `false`.

...
import 'package:flutter_readium_platform_interface/src/utils/uri_template.dart';
...
void main() {
  ...
  test('expand works fine with simple string templates', () {
    final template = UriTemplate('/url{x,hello,y}name{z,y,w}');
    final parameters = {
      'x': 'aaa',
      'hello': 'Hello, world',
      'y': 'b',
  ...
  test('expand works fine with form-style ampersand-separated templates', () {
    final template = UriTemplate('/url{?x,hello,y}name');
    final parameters = {'x': 'aaa', 'hello': 'Hello, world', 'y': 'b'};
    expect(

...
const val utilsChannelName = "dk.nota.flutter_readium/Utils"

/** R2NavigatorFlutterPlugin */
class R2NavigatorFlutterPlugin : FlutterPlugin, MethodCallHandler {
  ...
  override fun onAttachedToEngine(flutterPluginBinding: FlutterPluginBinding) {
    ...
    // Setup main plugin channel
    utilsChannel = MethodChannel(flutterPluginBinding.binaryMessenger, utilsChannelName)

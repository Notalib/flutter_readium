...
extension ReadiumXmlNodeExtension on XmlNode {
  ...
  String? get lang => isPageBreak ? FlutterReadium.state.appLanguage : getAttribute('lang');
  ...
  String get physicalPageIndexSemanticsLabel =>
      FlutterReadium.state.physicalPageIndexSemanticsFormatter
          ?.call(getAttribute('title') ?? altOrText) ??
      altOrText;

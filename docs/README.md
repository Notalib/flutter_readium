# flutter_readium Documentation

A Flutter plugin for reading EPUB, audiobook, and WebPub publications, wrapping the [Readium](https://readium.org) toolkits.

## Contents

### Getting Started
- [Installation](getting-started/installation.md) — add the package and configure each platform
- [Quick Start](getting-started/quick-start.md) — open a book and display its contents
- [Core Concepts](getting-started/concepts.md) — Publication, Locator, Link, and the event model
...
- [Decorations](api-reference/decorations.md)

...
| `setAudioRecoveryPolicy(policy)` | Configure audio-stream error recovery and resource-loading watchdog reporting/recovery. See [error-codes.md](./error-codes.md#audiorecoverypolicy) |
